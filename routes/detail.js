        ...
        // console.log("session : " + req.session.user_name+" / "+req.session.emp_num);
            ...
            connectionPool.getConnection(function(err, connection) {
                ...
                if(error) {
                    ...
                    if(rows.length > 0) {
                        connection.query('select t1.user_name, t1.sm_id from user t1, (select b.happyday_id, b.user_id from happyday_master a, happyday_user_hst b where a.happyday_id = b.happyday_id and b.happyday_id = ?) t2 where t1.id = t2.user_id;', req.params.id, function(error, rows1){
